...
def _load_impl_module(mock: bool):
    modname = ".viewpoint_mock" if mock else ".viewpoint_real"
    return import_module(modname, package=__package__)


def get_function_by_name_viewpoint(name: str, mock: bool = False) -> Resolver:
...
def _load_gt_module(mock: bool):
    modname = ".viewpoint_mock_results"
    return import_module(modname, package=__package__)


def get_result_by_name_viewpoint(name: str, mock: bool = False) -> Any:
