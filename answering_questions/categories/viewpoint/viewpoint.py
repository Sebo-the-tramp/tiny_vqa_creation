...
def _load_impl_module(counterfactual: bool):
    modname = ".viewpoint_questions_cf" if counterfactual else ".viewpoint_questions"
...
def _get_function_by_name_viewpoint(name: str, counterfactual: bool) -> Resolver:
...
def get_function_by_name_viewpoint(name: str) -> Resolver:
    return _get_function_by_name_viewpoint(
