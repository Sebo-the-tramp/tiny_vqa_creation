...
def _load_impl_module_cf(mock: bool):
    modname = ".mechanics_questions_cf" if mock else ".mechanics_real"
    return import_module(modname, package=__package__)


def get_function_by_name_mechanics_cf(name: str, mock: bool = False) -> Resolver:
...
def _load_gt_module_cf(mock: bool):
    modname = ".mechanics_questions_results_cf"
    return import_module(modname, package=__package__)


def get_result_by_name_mechanics_cf(name: str, mock: bool = False) -> Any:
