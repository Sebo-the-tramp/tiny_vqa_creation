...
rsync -avz -e "ssh -i ~/.ssh/id_rsa_karolina" it4i-thvu@login2.karolina.it4i.cz:/mnt/proj1/eu-25-92/tiny_vqa_creation/output/results_run03_5K/ ./output/results_run03_5K