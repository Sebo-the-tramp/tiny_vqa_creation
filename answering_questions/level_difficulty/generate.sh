...
if [ -d "/scratch/project/eu-25-92/composite_physics/dataset/simulation_v4" ]; then
    ...
    INPUT_PATH="/mnt/proj1/eu-25-92/tiny_vqa_creation/output/run_11_general/test_run_10_general_10K.json"
...
if [ -d "/data0/sebastian.cavada/datasets/simulations_v4" ]; then
    ...
    INPUT_PATH="--input /data0/sebastian.cavada/compositional-physics/tiny_vqa_deterministic/output/run_10_general/test_run_10_general_10K.json"
