...
# fig.add_annotation(
#     text=f"Object<br>Permanence<br>{_pct_text(object_permanence_total_count, total_count)}",
#     x=OBJECT_PERMANENCE_LABEL_X,
#     y=OBJECT_PERMANENCE_LABEL_Y,
#     showarrow=False,
#     font=dict(size=21, color="#ffffff", family="Arial"),
#     xref="paper",
#     yref="paper",
# )
fig.add_annotation(
    text=(
        f"Object<br>Permanence<br>"
        f"Count {_pct_text(object_count_count, total_count)}"
        f"<br>| Identity {_pct_text(object_identity_count, total_count)}"
    ),
    x=1.12,
    y=0.5,
    showarrow=False,
    font=dict(size=18, color="#444444", family="Arial"),
    xref="paper",
    yref="paper",
)
fig.add_annotation(
...
# fig.add_annotation(
#     text="Temporal<br>Reasoning",
#     x=0.625,
#     y=0.36,
#     showarrow=False,
#     font=dict(size=9.510, color="#FFFFFF", family="Arial"),
# )
