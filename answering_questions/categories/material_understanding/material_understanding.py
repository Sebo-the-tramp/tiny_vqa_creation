...
def _load_impl_module(mock: bool):
    modname = ".material_understanding_questions" if mock else ".material_understanding_real"
    return import_module(modname, package=__package__)


def get_function_by_name_material_understanding(name: str, mock: bool = False) -> Resolver:
