...
def _load_impl_module(counterfactual: bool):
    modname = (
        ".persistence_questions_cf" if counterfactual else ".persistence_questions"
    )
...
def _get_function_by_name_persistence(name: str, counterfactual: bool) -> Resolver:
...
def get_function_by_name_persistence(name: str) -> Resolver:
    return _get_function_by_name_persistence(
