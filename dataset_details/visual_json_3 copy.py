...
fig.add_shape(
    ...
    x1=NEW_BOX_X - 0.05, y1=NEW_BOX_Y - 0.05,
...
fig.add_annotation(
    text=(
        ...
        f"<b style='color:{mapping_cat_colors['permanence']}'>Object Permanence</b><br>"
        # List the sub-categories with their calculated percentages
        f"• Count: {_pct_text(object_count_count, total_count)}<br>"
        f"• Identity: {_pct_text(object_identity_count, total_count)}"
    ),
    ...
    font=dict(size=20, color="#222222", family="Arial"),
