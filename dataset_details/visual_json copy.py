...
THRESHOLD = 0.05
EXCLUDE_LABELS = ["Material<br>Identification", "Mechanics"]  # e.g. ["Viewpoint", "Temporal<br>Reasoning"]
...
permanence_count = main_totals[persistence_key]
...
fig.add_annotation(text="Mechanics", x=0.78, y=0.465, showarrow=False, font=dict(size=22, color="#ffffff", family="Arial"), xref="paper", yref="paper")
...
fig.add_annotation(
    text=f"Object<br>Permanence<br>{_pct_text(permanence_count, total_count)}",
    x=1.125,
    y=0.51,
    showarrow=False,
    font=small_label_font,
...
fig.add_annotation(
    ...
    y=0.97,
    showarrow=False,
    font=small_label_font_internal,
    xref="paper",
    yref="paper",
)
