...
from utils.utils_graph_correlation import create_num_objects_violin_grid
...
def main() -> None:
    ...
    create_num_objects_violin_grid(
        eval_df,
        group_by="model_id",
        filename="num_objects_violin_grid_models.png",
    ...
    create_num_objects_violin_grid(
        eval_df,
        group_by="family",
        filename="num_objects_violin_grid_families.png",
        save_per_category=True,
